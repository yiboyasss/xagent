...
class UserSkillFile(Base):  # type: ignore
    ...
    __table_args__ = (UniqueConstraint("skill_id", "path", name="uq_user_skill_file_path"),)

    id = Column(Integer, primary_key=True, index=True)
    skill_id = Column(Integer, ForeignKey("user_skills.id", ondelete="CASCADE"), nullable=False)
