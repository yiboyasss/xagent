...
def upgrade() -> None:
    ...
    with op.batch_alter_table('uploaded_files', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_uploaded_files_file_id'), ['file_id'], unique=True)
        batch_op.create_unique_constraint(batch_op.f('uq_uploaded_files_storage_path'), ['storage_path'])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('uploaded_files', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_uploaded_files_storage_path'), type_='unique')
